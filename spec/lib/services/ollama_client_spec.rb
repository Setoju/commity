...
RSpec.describe Commity::OllamaClient do
  ...
  describe ".generate" do
    it "normalizes timeout and temperature values before POST" do
      response = instance_double("HTTParty::Response", success?: true, body: { message: { content: "ok" } }.to_json, code: 200)
    ...
    it "includes Ollama error details when present" do
      response = instance_double("HTTParty::Response", success?: false, body: { error: "invalid model" }.to_json, code: 500)
